...
export default class Hasil1 extends Component<{}>{
  ...
  render() {
    ...
    <Image style={styles.imagewrap}
          ...
          <Text style = {styles.informasi}>SDN 1 Pempatan, Karangasem Bali</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>Karangasem, Pempatan, Kec. Rendang</Text>
          </View>

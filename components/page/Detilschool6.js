...
export default class Detilschool6 extends Component<{}>{
  ...
  render() {
    return (
      ...
      <View style={styles.teksSekolah}>
            <Text style = {styles.namaSekolah}>SDN 6 PEMPATAN</Text>
          </View>

    <Image style={styles.imagewrap}
          source={require('../image/sdn6pempatan.png')}/>
          ...
          <Text style = {styles.informasi}>SDN 6 Pempatan, Karangasem Bali</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>50 Siswa</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>15 km</Text>
          </View>

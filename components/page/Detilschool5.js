...
export default class Detilschool5 extends Component<{}>{
  ...
  render() {
    return (
      ...
      <View style={styles.teksSekolah}>
            <Text style = {styles.namaSekolah}>SDN 5 PEMPATAN</Text>
          </View>

    <Image style={styles.imagewrap}
          source={require('../image/sdn5pempatan.png')}/>
          ...
          <Text style = {styles.informasi}>SDN 5 Pempatan, Karangasem Bali</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>Pemuteran, Pempatan, Kec. Rendang</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>54 Siswa</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>14 Orang</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>20 km</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>30 km</Text>
          </View>

...
export default class Detilschool4 extends Component<{}>{
  ...
  render() {
    return (
      ...
      <View style={styles.teksSekolah}>
            <Text style = {styles.namaSekolah}>SDN 4 PEMPATAN</Text>
          </View>

    <Image style={styles.imagewrap}
          source={require('../image/sdn4pempatan.png')}/>
          ...
          <Text style = {styles.informasi}>SDN 4 Pempatan, Karangasem Bali</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>Pempatan, Pempatan, Kec. Rendang</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>35 Siswa</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>8 Orang</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>82 km</Text>
          </View>

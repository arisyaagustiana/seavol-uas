...
export default class Detilschool3 extends Component<{}>{
  ...
  render() {
    return (
      ...
      <View style={styles.teksSekolah}>
            <Text style = {styles.namaSekolah}>SDN 3 PEMPATAN</Text>
          </View>

    <Image style={styles.imagewrap}
          source={require('../image/sdn3pempatan.png')}/>
          ...
          <Text style = {styles.informasi}>SDN 3 Pempatan, Karangasem Bali</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>Dusun Alasngandang, Pempatan, Kec. Rendang</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>32 Siswa</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>12 Orang</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>75 km</Text>
          </View>

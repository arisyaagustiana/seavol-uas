...
export default class Detilschool8 extends Component<{}>{
  ...
  render() {
    return (
      ...
      <View style={styles.teksSekolah}>
            <Text style = {styles.namaSekolah}>SDN 8 PEMPATAN</Text>
          </View>

    <Image style={styles.imagewrap}
          source={require('../image/sdn8pempatan.png')}/>
          ...
          <Text style = {styles.informasi}>SDN 8 Pempatan, Karangasem Bali</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>Keladian, Pempatan, Kec. Rendang</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>58 Siswa</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>18 Orang</Text>
          </View>
          ...
          <View style={styles.boxDetail}>
          <Text style = {styles.informasi}>68 km</Text>
          </View>
